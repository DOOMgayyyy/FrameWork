class Math3D {
    ...
    xs(point) {
        const zs = this.WIN.CENTER.z; //координата центра сцены по z.
        const z0 = this.WIN.CAMERA.z; //координата камеры по z.
        const x0 = this.WIN.CAMERA.x; //координата камеры по x.
